...
_haseb setdir _direction;     _holder = createvehicle ["GroundWeaponHolder_Scripted", _spawnpos, [], 0, "can_collide"];     
 hideobject _haseb;   
  _y = getdir _haseb;       
_holder addmagazinecargoglobal ["CUP_OG7_M",1];      
...
[_rocket, 1] execVM "siege_core\server\sys_basedefence\IDF_cram.sqf";[_holder,_range] execvm "siege_core\server\sys_basedefence\IDF_marker.sqf"; sleep 3;if (idfon == 0) then { 
