...
enemyTechnical = ["CUP_O_LR_MG_TKM", "CUP_O_ZU23_TK_INS", "CUP_O_LR_SPG9_TKM", "CUP_O_Hilux_zu23_TK_INS", "CUP_O_Hilux_SPG9_TK_INS", "CUP_O_Hilux_DSHKM_TK_INS"];

_script = execVM "siege_core\SHK_pos\shk_pos_init.sqf";
waitUntil{scriptDone _script};


badTownArray = ["Airport north","Yarum","Falar","Faro","Guran","Feas"];
